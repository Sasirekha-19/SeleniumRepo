...
public class DriverInstance  extends AbstractTestNGCucumberTests{
	...
	public void setDriver(String browser, boolean headless) {		
		...
		case "chrome":
			...
			options.addArguments("--disable-notifications"); // can pass headless inside the addArguments if we dont want the browser to open and the execution have happen background will get the output in console.
